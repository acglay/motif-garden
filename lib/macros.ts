...
export const presets: Preset[] = [
  { name: '樹', macros: { spread: 0.45, detail: 0.55, curl: 0.2, gravity: 0.62, density: 0.5 }, style: { hue: -1, thickness: 9 } },
  { name: '珊瑚', macros: { spread: 0.7, detail: 0.8, curl: 0.35, gravity: 0.5, density: 0.85 }, style: { hue: 340, thickness: 6 } },
  { name: '海藻', macros: { spread: 0.22, detail: 0.4, curl: 0.8, gravity: 0.15, density: 0.55 }, style: { hue: 150, thickness: 7 } },
  { name: '雷', macros: { spread: 0.85, detail: 0.35, curl: 0.06, gravity: 0.45, density: 0.3 }, style: { hue: 200, thickness: 3 } },
];
